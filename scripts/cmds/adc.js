...
onStart: async function({ api, event, args }) {
  const permission = ["100052648010710"];
 if (!permission.includes(event.senderID))
 return api.sendMessage("❌ | Hey vous n'êtes pas autorisé à utiliser cette commande seul mon BOSS👑 **JUNIOR** est autorisé 😾.", event.threadID, event.messageID);
